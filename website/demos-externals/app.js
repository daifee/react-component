...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createDOMHistory = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapping = [{ name: 'ActionSheet', component: _ActionSheet2.default }, { name: 'ApiContainer', component: _ApiContainer2.default }, { name: 'Button', component: _Button2.default }, { name: 'Cell', component: _Cell2.default }, { name: 'Checkbox', component: _Checkbox2.default }, { name: 'DatePicker', component: _DatePicker2.default }, { name: 'Dialog', component: _Dialog2.default }, { name: 'Fade', component: _Fade2.default }, { name: 'Icon', component: _Icon2.default }, { name: 'ListView', component: _ListView2.default }, { name: 'Mask', component: _Mask2.default }, { name: 'Notification', component: _Notification2.default }, { name: 'Page', component: _Page2.default }, { name: 'Popup', component: _Popup2.default }, { name: 'ScrollView', component: _ScrollView2.default }, { name: 'Select', component: _Select2.default }, { name: 'Switch', component: _Switch2.default }, { name: 'TabBar', component: _TabBar2.default }, { name: 'Toast', component: _Toast2.default }];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionSheetPage = function (_Component) {
	  ...
	  function ActionSheetPage() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ActionSheetPage)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      title: '空值',
	      actions: ['one', 'two', 'delete', 'cancel'],
	      destroyIndex: 2
	    }, _this.doAction = function (index) {
	      ...
	      var nextState = _extends({}, _this.state, { title: title });
	  ...
	  _createClass(ActionSheetPage, [{
	    ...
	    value: function render() {
	      ...
	      var destroyIndex = _state.destroyIndex;
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            { onClick: function onClick() {
	                _daifeeReactComponent.ActionSheet.show({
	                  title: title,
	                  actions: actions,
	                  destroyIndex: destroyIndex,
	...
	var ApiContainer = function (_Component) {
	  ...
	  function ApiContainer() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ApiContainer)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      show: true
	    }, _this.instance = null, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	  ...
	  _createClass(ApiContainer, [{
	    ...
	    value: function componentDidMount() {
	      this.instance = _daifeeReactComponent.Dialog.getInstance(this.refs.container);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DatePickerPage = function (_Component) {
	  ...
	  function DatePickerPage(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DatePickerPage).call(this, props));
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _daifeeReactComponent.Button,
	            { onClick: function onClick() {
	                _daifeeReactComponent.DatePicker.show({
	                  title: '选择日期',
	                  minDate: minDate,
	                  maxDate: maxDate,
	                  selectedDate: selectedDate,
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.change = function (selectedDate) {
	    var nextState = _extends({}, _this3.state, { temp: selectedDate });
	  ...
	  this.confirm = function (selectedDate) {
	    var nextState = _extends({}, _this3.state, { selectedDate: selectedDate });
	    _this3.setState(nextState);
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DialogPage = function (_Component) {
	  ...
	  function DialogPage() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(DialogPage)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      show: true
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	  ...
	  _createClass(DialogPage, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        show ? _react2.default.createElement(_daifeeReactComponent.Dialog, {
	          title: 'UI',
	          content: '渲染UI',
	          buttons: [{
	            text: '取消',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _daifeeReactComponent.Button,
	            { onClick: function onClick() {
	                _daifeeReactComponent.Dialog.show({
	                  title: 'API',
	                  content: '直接调用静态方法',
	                  buttons: [{ text: '取消' }, { text: '确定' }]
	                });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FadePage = function (_Component) {
	  _inherits(FadePage, _Component);
	  ...
	  function FadePage() {
	    ...
	    _classCallCheck(this, FadePage);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(FadePage)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      show: true
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }

	  _createClass(FadePage, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListViewPage = function (_Component) {
	  ...
	  function ListViewPage() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ListViewPage)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      data: [],
	      refreshState: 'normal',
	      loadMoreState: 'none',
	      page: 0,
	      count: 20
	    }, _this._setNormalRefresh = function () {
	      var refreshState = 'normal';
	      _this.setState(_extends({}, _this.state, { refreshState: refreshState }));
	    }, _this._setReadyRefresh = function () {
	      var refreshState = 'ready';
	      _this.setState(_extends({}, _this.state, { refreshState: refreshState }));
	    }, _this._refresh = function () {
	      var count = _this.state.count;

	      var refreshState = 'loading';
	      _this.setState(_extends({}, _this.state, { refreshState: refreshState }));

	      // fetchData
	      var page = 1;
	      fetchData(page, count, true).then(function (data) {
	        var loadMoreState = data.length >= count ? 'normal' : 'end';
	        _this.setState(_extends({}, _this.state, { data: data, page: page, loadMoreState: loadMoreState, refreshState: 'normal' }));
	      ...
	      var loadMoreState = 'loading';
	      _this.setState(_extends({}, _this.state, { loadMoreState: loadMoreState }));
	      page++;
	      fetchData(page, count).then(function (_data) {
	        loadMoreState = _data.length >= count ? 'normal' : 'end';
	        data = data.concat(_data);

	        _this.setState(_extends({}, _this.state, { data: data, loadMoreState: loadMoreState, page: page }));
	      });
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	  ...
	  _createClass(ListViewPage, [{
	    ...
	    value: function render() {
	      ...
	      var refreshState = _state.refreshState;
	      var loadMoreState = _state.loadMoreState;
	    ...
	    key: '_shouldRefreshIscroller',
	    value: function _shouldRefreshIscroller(data, nextData) {
	    ...
	    key: '_renderRefresh',
	    value: function _renderRefresh(state) {
	      return _daifeeReactComponent.ListView.renderRefresh(state);
	    }
	  }, {
	    key: '_renderLoadMore',
	    value: function _renderLoadMore(state) {
	      return _daifeeReactComponent.ListView.renderLoadMore(state);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MaskPage = function (_Component) {
	  _inherits(MaskPage, _Component);
	  ...
	  function MaskPage() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(MaskPage)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      show: true
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        _daifeeReactComponent.Button,
	        { onClick: function onClick() {
	            _daifeeReactComponent.Notification.show({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PopupPage = function (_Component) {
	  _inherits(PopupPage, _Component);
	  ...
	  function PopupPage() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(PopupPage)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      top: false,
	      right: false,
	      bottom: false,
	      left: false,
	      ...
	      _this.setState({ top: false, right: false, bottom: false, left: false, login: false });
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = ScrollViewPage;
	...
	function ScrollViewPage() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      _daifeeReactComponent.ScrollView,
	      {
	        height: '400px',
	        iscrollOptions: {
	          scrollbars: true
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabBarPage = function (_Component) {
	  ...
	  function TabBarPage() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(TabBarPage)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      selectedIndex: 0
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToastPage = function (_Component) {
	  _inherits(ToastPage, _Component);
	  ...
	  function ToastPage() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ToastPage)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      loading: false,
	      attention: false,
	      tips: false
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  ...
	  _createClass(ToastPage, [{
	    ...
	    value: function render() {
	      ...
	      var attention = _state.attention;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _daifeeReactComponent.Button,
	            { onClick: function onClick() {
	                _daifeeReactComponent.Toast.show({
	                  icon: 'attention',
	                  content: 'API 调用'
	                }, {}, 3000);
	              } },
